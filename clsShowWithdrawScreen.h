...
class clsShowWithdrawScreen : public clsScreen {
...
public:
	static void ShowWithdrawScreen()
	{
		...
		{
			cout << "Insufficient balance! Available balance is: " << Client.AccountBalance << ". Please enter a valid amount: ";
			Amount = clsInputValidate<double>::ReadNumberBetween(0, 50000);
		}
		...
		{
			cout << "\nWithdraw transaction canceled." << endl;
		}
